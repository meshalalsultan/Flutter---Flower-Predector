...
class TermOfServicesDialog extends StatefulWidget {
  final String value;
  TermOfServicesDialog({Key key, @required this.value}) : super(key: key);

  @override
  _TermOfServicesDialogState createState() => _TermOfServicesDialogState(value);
}

class _TermOfServicesDialogState extends State<TermOfServicesDialog> {
  String value;
  _TermOfServicesDialogState(this.value);
  @override
...
class DialogTerfOfService extends StatefulWidget {
  final String value;
  DialogTerfOfService({Key key, @required this.value}) : super(key: key);

  @override
  _DialogTerfOfServiceState createState() => _DialogTerfOfServiceState(value);
}

class _DialogTerfOfServiceState extends State<DialogTerfOfService> {
  String value;
  _DialogTerfOfServiceState(this.value);
  @override
  Widget build(BuildContext context) {
    return Container(
